...
extern lcd_size_t g_lcd_size;
/* 设置横屏或者竖屏显示 0或1为竖屏 2或3为横屏 由lcd初始化函数的参数dir决定*/
...
#define LCD_GREEN      0x0400 // 0x07E0
...
/* =0不特殊处理，=1中间对齐，=2中间对齐清空空余，=3左对齐, =4左对齐清空空余，=5右对齐，=6右对齐清空空余 */
typedef enum {
    E_LCD_SCREEN_ALIGN_NONE = 0,
    E_LCD_SCREEN_ALIGN_MID,
    E_LCD_SCREEN_ALIGN_MID_NOP,
    E_LCD_SCREEN_ALIGN_LEFT,
    E_LCD_SCREEN_ALIGN_LEFT_NOP,
    E_LCD_SCREEN_ALIGN_RIGHT,
    E_LCD_SCREEN_ALIGN_RIGHT_NOP,

} lcd_screen_align_type_e;
